...
d = schemdraw.Drawing()
d += elm.Label().label("Filtro Passa-Baixa RL (Aplicação)", fontsize=16, loc='top').at((2,4))
...
plt.title("Resposta em Frequência - Filtro Passa-Baixa RL (Aplicação) (ω)")
plt.ylabel("|H(jω)|")
...
plt.title("Resposta em Frequência - Filtro Passa-Baixa RL (Aplicação) (Hz)")
